...
export default async function KontakPage() {
  ...
  const ops = contact.operationalHours || {}
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100">Kami Siap Melayani Anda</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Telp: {contact.phone || "-"}</p>
                  {contact.whatsapp && <p className="text-gray-600">WA: {contact.whatsapp}</p>}
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Senin - Jumat: {ops.weekdays || "08:00 - 16:00"}<br/>
                    Sabtu: {ops.saturday || "08:00 - 12:00"}<br/>
                    Minggu & Libur: {ops.sunday || "Tutup"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <form className="space-y-4">
              {/* Form fields remain the same for now */}
              <div>
        ...
        {/* Map */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Lokasi Kantor Desa</h2>
          <div className="aspect-video bg-gray-200 rounded-2xl overflow-hidden shadow-xl">
             {contact.mapUrl ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-gray-500">
                    Map belum diatur di Admin Settings
                </div>
             )}
          </div>
        </div>
