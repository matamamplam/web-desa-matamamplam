...
export default function PublicNavbar({ siteName = 'Desa Mata Mamplam', logo }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-white/20 shadow-sm font-sans transition-all duration-300" ref={dropdownRef}>
      ...
      {/* Mobile Menu Panel */}
      <div className="lg:hidden fixed inset-0 z-[100] pointer-events-none overflow-hidden" style={{ height: '100dvh' }}>
        <div 
          className={`absolute top-0 bottom-0 right-0 w-72 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out pointer-events-auto ${
